...
type Deal struct {
	...
	Performer   User   `json:"-" gorm:"foreignKey:PerformerId;not null;constraint:OnDelete:CASCADE;"`
	Notice      Notice `json:"-" gorm:"foreignKey:NoticeId;not null;association_foreignkey:ID;constraint:OnDelete:CASCADE;"`
}
